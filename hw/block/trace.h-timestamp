...
extern TraceEvent _TRACE_NVME_REGISTER_NAMESPACE_EVENT;
...
extern TraceEvent _TRACE_NVME_MAP_PRP_EVENT;
extern TraceEvent _TRACE_NVME_MAP_SGL_EVENT;
extern TraceEvent _TRACE_NVME_IO_CMD_EVENT;
extern TraceEvent _TRACE_NVME_RW_EVENT;
extern TraceEvent _TRACE_NVME_RW_CB_EVENT;
...
extern TraceEvent _TRACE_NVME_IDENTIFY_NS_LIST_EVENT;
extern TraceEvent _TRACE_NVME_IDENTIFY_NS_DESCRIPTOR_LIST_EVENT;
extern TraceEvent _TRACE_NVME_GETFEAT_EVENT;
extern TraceEvent _TRACE_NVME_SETFEAT_EVENT;
...
extern TraceEvent _TRACE_NVME_GET_LOG_EVENT;
extern TraceEvent _TRACE_NVME_PROCESS_AERS_EVENT;
extern TraceEvent _TRACE_NVME_AER_EVENT;
extern TraceEvent _TRACE_NVME_AER_AERL_EXCEEDED_EVENT;
extern TraceEvent _TRACE_NVME_AER_MASKED_EVENT;
extern TraceEvent _TRACE_NVME_AER_POST_CQE_EVENT;
extern TraceEvent _TRACE_NVME_ENQUEUE_REQ_COMPLETION_EVENT;
extern TraceEvent _TRACE_NVME_ENQUEUE_EVENT_EVENT;
extern TraceEvent _TRACE_NVME_NO_OUTSTANDING_AERS_EVENT;
...
extern TraceEvent _TRACE_NVME_ERR_EVENT;
extern TraceEvent _TRACE_NVME_ERR_INVALID_SGL_DESCRIPTOR_EVENT;
extern TraceEvent _TRACE_NVME_ERR_INVALID_SGL_EXCESS_LENGTH_EVENT;
...
extern TraceEvent _TRACE_NVME_ERR_INVALID_LOG_PAGE_EVENT;
...
extern TraceEvent _TRACE_NVME_ERR_INTERNAL_DEV_ERROR_EVENT;
...
extern uint16_t _TRACE_NVME_REGISTER_NAMESPACE_DSTATE;
...
extern uint16_t _TRACE_NVME_MAP_PRP_DSTATE;
extern uint16_t _TRACE_NVME_MAP_SGL_DSTATE;
extern uint16_t _TRACE_NVME_IO_CMD_DSTATE;
extern uint16_t _TRACE_NVME_RW_DSTATE;
extern uint16_t _TRACE_NVME_RW_CB_DSTATE;
...
extern uint16_t _TRACE_NVME_IDENTIFY_NS_LIST_DSTATE;
extern uint16_t _TRACE_NVME_IDENTIFY_NS_DESCRIPTOR_LIST_DSTATE;
extern uint16_t _TRACE_NVME_GETFEAT_DSTATE;
extern uint16_t _TRACE_NVME_SETFEAT_DSTATE;
...
extern uint16_t _TRACE_NVME_GET_LOG_DSTATE;
extern uint16_t _TRACE_NVME_PROCESS_AERS_DSTATE;
extern uint16_t _TRACE_NVME_AER_DSTATE;
extern uint16_t _TRACE_NVME_AER_AERL_EXCEEDED_DSTATE;
extern uint16_t _TRACE_NVME_AER_MASKED_DSTATE;
extern uint16_t _TRACE_NVME_AER_POST_CQE_DSTATE;
extern uint16_t _TRACE_NVME_ENQUEUE_REQ_COMPLETION_DSTATE;
extern uint16_t _TRACE_NVME_ENQUEUE_EVENT_DSTATE;
extern uint16_t _TRACE_NVME_NO_OUTSTANDING_AERS_DSTATE;
...
extern uint16_t _TRACE_NVME_ERR_DSTATE;
extern uint16_t _TRACE_NVME_ERR_INVALID_SGL_DESCRIPTOR_DSTATE;
extern uint16_t _TRACE_NVME_ERR_INVALID_SGL_EXCESS_LENGTH_DSTATE;
...
extern uint16_t _TRACE_NVME_ERR_INVALID_LOG_PAGE_DSTATE;
...
extern uint16_t _TRACE_NVME_ERR_INTERNAL_DEV_ERROR_DSTATE;
...
#define TRACE_NVME_REGISTER_NAMESPACE_ENABLED 1
...
#define TRACE_NVME_MAP_PRP_ENABLED 1
#define TRACE_NVME_MAP_SGL_ENABLED 1
#define TRACE_NVME_IO_CMD_ENABLED 1
#define TRACE_NVME_RW_ENABLED 1
#define TRACE_NVME_RW_CB_ENABLED 1
...
#define TRACE_NVME_IDENTIFY_NS_LIST_ENABLED 1
#define TRACE_NVME_IDENTIFY_NS_DESCRIPTOR_LIST_ENABLED 1
#define TRACE_NVME_GETFEAT_ENABLED 1
#define TRACE_NVME_SETFEAT_ENABLED 1
...
#define TRACE_NVME_GET_LOG_ENABLED 1
#define TRACE_NVME_PROCESS_AERS_ENABLED 1
#define TRACE_NVME_AER_ENABLED 1
#define TRACE_NVME_AER_AERL_EXCEEDED_ENABLED 1
#define TRACE_NVME_AER_MASKED_ENABLED 1
#define TRACE_NVME_AER_POST_CQE_ENABLED 1
#define TRACE_NVME_ENQUEUE_REQ_COMPLETION_ENABLED 1
#define TRACE_NVME_ENQUEUE_EVENT_ENABLED 1
#define TRACE_NVME_NO_OUTSTANDING_AERS_ENABLED 1
...
#define TRACE_NVME_ERR_ENABLED 1
#define TRACE_NVME_ERR_INVALID_SGL_DESCRIPTOR_ENABLED 1
#define TRACE_NVME_ERR_INVALID_SGL_EXCESS_LENGTH_ENABLED 1
...
#define TRACE_NVME_ERR_INVALID_LOG_PAGE_ENABLED 1
...
#define TRACE_NVME_ERR_INTERNAL_DEV_ERROR_ENABLED 1
...
#define TRACE_NVME_REGISTER_NAMESPACE_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_NVME_REGISTER_NAMESPACE) || \
    false)

static inline void _nocheck__trace_nvme_register_namespace(uint32_t nsid)
{
    if (trace_event_get_state(TRACE_NVME_REGISTER_NAMESPACE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nvme_register_namespace " "nsid %"PRIu32"" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , nsid);
    }
...
static inline void trace_nvme_register_namespace(uint32_t nsid)
{
    if (true) {
        _nocheck__trace_nvme_register_namespace(nsid);
    }
}
...
#define TRACE_NVME_MAP_PRP_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_NVME_MAP_PRP) || \
    false)

static inline void _nocheck__trace_nvme_map_prp(uint8_t cmd_opcode, uint64_t trans_len, uint32_t len, uint64_t prp1, uint64_t prp2, int num_prps)
{
    if (trace_event_get_state(TRACE_NVME_MAP_PRP) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nvme_map_prp " "cmd_opcode=0x%"PRIx8", trans_len=%"PRIu64", len=%"PRIu32", prp1=0x%"PRIx64", prp2=0x%"PRIx64", num_prps=%d" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , cmd_opcode, trans_len, len, prp1, prp2, num_prps);
    }
}

static inline void trace_nvme_map_prp(uint8_t cmd_opcode, uint64_t trans_len, uint32_t len, uint64_t prp1, uint64_t prp2, int num_prps)
{
    if (true) {
        _nocheck__trace_nvme_map_prp(cmd_opcode, trans_len, len, prp1, prp2, num_prps);
    }
}

#define TRACE_NVME_MAP_SGL_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_NVME_MAP_SGL) || \
    false)

static inline void _nocheck__trace_nvme_map_sgl(uint16_t cid, uint8_t typ, uint16_t nlb, uint64_t len)
{
    if (trace_event_get_state(TRACE_NVME_MAP_SGL) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nvme_map_sgl " "cid %"PRIu16" type 0x%"PRIx8" nlb %"PRIu16" len %"PRIu64"" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , cid, typ, nlb, len);
    }
...
static inline void trace_nvme_map_sgl(uint16_t cid, uint8_t typ, uint16_t nlb, uint64_t len)
{
    if (true) {
        _nocheck__trace_nvme_map_sgl(cid, typ, nlb, len);
    }
}

#define TRACE_NVME_IO_CMD_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_NVME_IO_CMD) || \
    false)

static inline void _nocheck__trace_nvme_io_cmd(uint16_t cid, uint32_t nsid, uint8_t opcode)
{
    if (trace_event_get_state(TRACE_NVME_IO_CMD) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nvme_io_cmd " "cid %"PRIu16" nsid %"PRIu32" opc %"PRIu8"" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , cid, nsid, opcode);
    }
...
static inline void trace_nvme_io_cmd(uint16_t cid, uint32_t nsid, uint8_t opcode)
{
    if (true) {
        _nocheck__trace_nvme_io_cmd(cid, nsid, opcode);
    }
}
...
#define TRACE_NVME_RW_CB_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_NVME_RW_CB) || \
    false)

static inline void _nocheck__trace_nvme_rw_cb(uint16_t cid, uint32_t nsid)
{
    if (trace_event_get_state(TRACE_NVME_RW_CB) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nvme_rw_cb " "cid %"PRIu16" nsid %"PRIu32"" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , cid, nsid);
    }
...
static inline void trace_nvme_rw_cb(uint16_t cid, uint32_t nsid)
{
    if (true) {
        _nocheck__trace_nvme_rw_cb(cid, nsid);
    }
}
...
#define TRACE_NVME_IDENTIFY_NS_LIST_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_NVME_IDENTIFY_NS_LIST) || \
    false)

static inline void _nocheck__trace_nvme_identify_ns_list(uint16_t ns)
{
    if (trace_event_get_state(TRACE_NVME_IDENTIFY_NS_LIST) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nvme_identify_ns_list " "identify namespace list, nsid=%"PRIu16"" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , ns);
    }
...
static inline void trace_nvme_identify_ns_list(uint16_t ns)
{
    if (true) {
        _nocheck__trace_nvme_identify_ns_list(ns);
    }
}

#define TRACE_NVME_IDENTIFY_NS_DESCRIPTOR_LIST_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_NVME_IDENTIFY_NS_DESCRIPTOR_LIST) || \
    false)

static inline void _nocheck__trace_nvme_identify_ns_descriptor_list(uint16_t ns)
{
    if (trace_event_get_state(TRACE_NVME_IDENTIFY_NS_DESCRIPTOR_LIST) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nvme_identify_ns_descriptor_list " "identify namespace descriptor list, nsid=%"PRIu16"" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , ns);
    }
...
static inline void trace_nvme_identify_ns_descriptor_list(uint16_t ns)
{
    if (true) {
        _nocheck__trace_nvme_identify_ns_descriptor_list(ns);
    }
}

#define TRACE_NVME_GETFEAT_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_NVME_GETFEAT) || \
    false)

static inline void _nocheck__trace_nvme_getfeat(uint32_t fid)
{
    if (trace_event_get_state(TRACE_NVME_GETFEAT) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nvme_getfeat " "fid 0x%"PRIx32"" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , fid);
    }
...
static inline void trace_nvme_getfeat(uint32_t fid)
{
    if (true) {
        _nocheck__trace_nvme_getfeat(fid);
    }
}

#define TRACE_NVME_SETFEAT_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_NVME_SETFEAT) || \
    false)

static inline void _nocheck__trace_nvme_setfeat(uint32_t fid, uint32_t val)
{
    if (trace_event_get_state(TRACE_NVME_SETFEAT) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nvme_setfeat " "fid 0x%"PRIx32" val 0x%"PRIx32"" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , fid, val);
    }
...
static inline void trace_nvme_setfeat(uint32_t fid, uint32_t val)
{
    if (true) {
        _nocheck__trace_nvme_setfeat(fid, val);
    }
}
...
#define TRACE_NVME_GET_LOG_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_NVME_GET_LOG) || \
    false)

static inline void _nocheck__trace_nvme_get_log(uint16_t cid, uint16_t lid)
{
    if (trace_event_get_state(TRACE_NVME_GET_LOG) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nvme_get_log " "cid %"PRIu16" lid 0x%"PRIx16"" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , cid, lid);
    }
...
static inline void trace_nvme_get_log(uint16_t cid, uint16_t lid)
{
    if (true) {
        _nocheck__trace_nvme_get_log(cid, lid);
    }
}

#define TRACE_NVME_PROCESS_AERS_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_NVME_PROCESS_AERS) || \
    false)

static inline void _nocheck__trace_nvme_process_aers(void)
{
    if (trace_event_get_state(TRACE_NVME_PROCESS_AERS) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nvme_process_aers " "processing aers" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 );
    }
...
static inline void trace_nvme_process_aers(void)
{
    if (true) {
        _nocheck__trace_nvme_process_aers();
    }
}

#define TRACE_NVME_AER_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_NVME_AER) || \
    false)

static inline void _nocheck__trace_nvme_aer(uint16_t cid)
{
    if (trace_event_get_state(TRACE_NVME_AER) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nvme_aer " "cid %"PRIu16"" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , cid);
    }
...
static inline void trace_nvme_aer(uint16_t cid)
{
    if (true) {
        _nocheck__trace_nvme_aer(cid);
    }
}

#define TRACE_NVME_AER_AERL_EXCEEDED_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_NVME_AER_AERL_EXCEEDED) || \
    false)

static inline void _nocheck__trace_nvme_aer_aerl_exceeded(void)
{
    if (trace_event_get_state(TRACE_NVME_AER_AERL_EXCEEDED) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nvme_aer_aerl_exceeded " "aerl exceeded" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 );
    }
...
static inline void trace_nvme_aer_aerl_exceeded(void)
{
    if (true) {
        _nocheck__trace_nvme_aer_aerl_exceeded();
    }
}

#define TRACE_NVME_AER_MASKED_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_NVME_AER_MASKED) || \
    false)

static inline void _nocheck__trace_nvme_aer_masked(uint8_t type, uint8_t mask)
{
    if (trace_event_get_state(TRACE_NVME_AER_MASKED) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nvme_aer_masked " "type 0x%"PRIx8" mask 0x%"PRIx8"" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , type, mask);
    }
...
static inline void trace_nvme_aer_masked(uint8_t type, uint8_t mask)
{
    if (true) {
        _nocheck__trace_nvme_aer_masked(type, mask);
    }
}

#define TRACE_NVME_AER_POST_CQE_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_NVME_AER_POST_CQE) || \
    false)

static inline void _nocheck__trace_nvme_aer_post_cqe(uint8_t typ, uint8_t info, uint8_t log_page)
{
    if (trace_event_get_state(TRACE_NVME_AER_POST_CQE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nvme_aer_post_cqe " "type 0x%"PRIx8" info 0x%"PRIx8" lid 0x%"PRIx8"" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , typ, info, log_page);
    }
...
static inline void trace_nvme_aer_post_cqe(uint8_t typ, uint8_t info, uint8_t log_page)
{
    if (true) {
        _nocheck__trace_nvme_aer_post_cqe(typ, info, log_page);
    }
}

#define TRACE_NVME_ENQUEUE_REQ_COMPLETION_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_NVME_ENQUEUE_REQ_COMPLETION) || \
    false)

static inline void _nocheck__trace_nvme_enqueue_req_completion(uint16_t cid, uint16_t cqid)
{
    if (trace_event_get_state(TRACE_NVME_ENQUEUE_REQ_COMPLETION) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nvme_enqueue_req_completion " "cid %"PRIu16" cqid %"PRIu16"" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , cid, cqid);
    }
...
static inline void trace_nvme_enqueue_req_completion(uint16_t cid, uint16_t cqid)
{
    if (true) {
        _nocheck__trace_nvme_enqueue_req_completion(cid, cqid);
    }
}

#define TRACE_NVME_ENQUEUE_EVENT_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_NVME_ENQUEUE_EVENT) || \
    false)

static inline void _nocheck__trace_nvme_enqueue_event(uint8_t typ, uint8_t info, uint8_t log_page)
{
    if (trace_event_get_state(TRACE_NVME_ENQUEUE_EVENT) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nvme_enqueue_event " "type 0x%"PRIx8" info 0x%"PRIx8" lid 0x%"PRIx8"" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , typ, info, log_page);
    }
...
static inline void trace_nvme_enqueue_event(uint8_t typ, uint8_t info, uint8_t log_page)
{
    if (true) {
        _nocheck__trace_nvme_enqueue_event(typ, info, log_page);
    }
}

#define TRACE_NVME_NO_OUTSTANDING_AERS_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_NVME_NO_OUTSTANDING_AERS) || \
    false)

static inline void _nocheck__trace_nvme_no_outstanding_aers(void)
{
    if (trace_event_get_state(TRACE_NVME_NO_OUTSTANDING_AERS) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nvme_no_outstanding_aers " "ignoring event; no outstanding AERs" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 );
    }
...
static inline void trace_nvme_no_outstanding_aers(void)
{
    if (true) {
        _nocheck__trace_nvme_no_outstanding_aers();
    }
}
...
#define TRACE_NVME_ERR_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_NVME_ERR) || \
    false)

static inline void _nocheck__trace_nvme_err(uint16_t cid, const char * s, uint16_t status)
{
    if (trace_event_get_state(TRACE_NVME_ERR) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nvme_err " "cid %"PRIu16" \"%s\" status 0x%"PRIx16"" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , cid, s, status);
    }
...
static inline void trace_nvme_err(uint16_t cid, const char * s, uint16_t status)
{
    if (true) {
        _nocheck__trace_nvme_err(cid, s, status);
    }
}

#define TRACE_NVME_ERR_INVALID_SGL_DESCRIPTOR_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_NVME_ERR_INVALID_SGL_DESCRIPTOR) || \
    false)

static inline void _nocheck__trace_nvme_err_invalid_sgl_descriptor(uint16_t cid, uint8_t typ)
{
    if (trace_event_get_state(TRACE_NVME_ERR_INVALID_SGL_DESCRIPTOR) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nvme_err_invalid_sgl_descriptor " "cid %"PRIu16" type 0x%"PRIx8"" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , cid, typ);
    }
...
static inline void trace_nvme_err_invalid_sgl_descriptor(uint16_t cid, uint8_t typ)
{
    if (true) {
        _nocheck__trace_nvme_err_invalid_sgl_descriptor(cid, typ);
    }
}

#define TRACE_NVME_ERR_INVALID_SGL_EXCESS_LENGTH_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_NVME_ERR_INVALID_SGL_EXCESS_LENGTH) || \
    false)

static inline void _nocheck__trace_nvme_err_invalid_sgl_excess_length(uint16_t cid)
{
    if (trace_event_get_state(TRACE_NVME_ERR_INVALID_SGL_EXCESS_LENGTH) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nvme_err_invalid_sgl_excess_length " "cid %"PRIu16"" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , cid);
    }
...
static inline void trace_nvme_err_invalid_sgl_excess_length(uint16_t cid)
{
    if (true) {
        _nocheck__trace_nvme_err_invalid_sgl_excess_length(cid);
    }
}
...
#define TRACE_NVME_ERR_INVALID_LOG_PAGE_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_NVME_ERR_INVALID_LOG_PAGE) || \
    false)

static inline void _nocheck__trace_nvme_err_invalid_log_page(uint16_t cid, uint16_t lid)
{
    if (trace_event_get_state(TRACE_NVME_ERR_INVALID_LOG_PAGE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nvme_err_invalid_log_page " "cid %"PRIu16" lid 0x%"PRIx16"" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , cid, lid);
    }
...
static inline void trace_nvme_err_invalid_log_page(uint16_t cid, uint16_t lid)
{
    if (true) {
        _nocheck__trace_nvme_err_invalid_log_page(cid, lid);
    }
}
...
#define TRACE_NVME_ERR_INTERNAL_DEV_ERROR_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_NVME_ERR_INTERNAL_DEV_ERROR) || \
    false)

static inline void _nocheck__trace_nvme_err_internal_dev_error(const char * reason)
{
    if (trace_event_get_state(TRACE_NVME_ERR_INTERNAL_DEV_ERROR) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nvme_err_internal_dev_error " "%s" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , reason);
    }
...
static inline void trace_nvme_err_internal_dev_error(const char * reason)
{
    if (true) {
        _nocheck__trace_nvme_err_internal_dev_error(reason);
    }
}
