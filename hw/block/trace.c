...
uint16_t _TRACE_NVME_REGISTER_NAMESPACE_DSTATE;
...
uint16_t _TRACE_NVME_MAP_PRP_DSTATE;
uint16_t _TRACE_NVME_MAP_SGL_DSTATE;
uint16_t _TRACE_NVME_IO_CMD_DSTATE;
uint16_t _TRACE_NVME_RW_DSTATE;
uint16_t _TRACE_NVME_RW_CB_DSTATE;
...
uint16_t _TRACE_NVME_IDENTIFY_NS_LIST_DSTATE;
uint16_t _TRACE_NVME_IDENTIFY_NS_DESCRIPTOR_LIST_DSTATE;
uint16_t _TRACE_NVME_GETFEAT_DSTATE;
uint16_t _TRACE_NVME_SETFEAT_DSTATE;
...
uint16_t _TRACE_NVME_GET_LOG_DSTATE;
uint16_t _TRACE_NVME_PROCESS_AERS_DSTATE;
uint16_t _TRACE_NVME_AER_DSTATE;
uint16_t _TRACE_NVME_AER_AERL_EXCEEDED_DSTATE;
uint16_t _TRACE_NVME_AER_MASKED_DSTATE;
uint16_t _TRACE_NVME_AER_POST_CQE_DSTATE;
uint16_t _TRACE_NVME_ENQUEUE_REQ_COMPLETION_DSTATE;
uint16_t _TRACE_NVME_ENQUEUE_EVENT_DSTATE;
uint16_t _TRACE_NVME_NO_OUTSTANDING_AERS_DSTATE;
...
uint16_t _TRACE_NVME_ERR_DSTATE;
uint16_t _TRACE_NVME_ERR_INVALID_SGL_DESCRIPTOR_DSTATE;
uint16_t _TRACE_NVME_ERR_INVALID_SGL_EXCESS_LENGTH_DSTATE;
...
uint16_t _TRACE_NVME_ERR_INVALID_LOG_PAGE_DSTATE;
...
uint16_t _TRACE_NVME_ERR_INTERNAL_DEV_ERROR_DSTATE;
...
TraceEvent _TRACE_NVME_REGISTER_NAMESPACE_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "nvme_register_namespace",
    .sstate = TRACE_NVME_REGISTER_NAMESPACE_ENABLED,
    .dstate = &_TRACE_NVME_REGISTER_NAMESPACE_DSTATE 
};
...
TraceEvent _TRACE_NVME_MAP_PRP_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "nvme_map_prp",
    .sstate = TRACE_NVME_MAP_PRP_ENABLED,
    .dstate = &_TRACE_NVME_MAP_PRP_DSTATE 
};
TraceEvent _TRACE_NVME_MAP_SGL_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "nvme_map_sgl",
    .sstate = TRACE_NVME_MAP_SGL_ENABLED,
    .dstate = &_TRACE_NVME_MAP_SGL_DSTATE 
};
TraceEvent _TRACE_NVME_IO_CMD_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "nvme_io_cmd",
    .sstate = TRACE_NVME_IO_CMD_ENABLED,
    .dstate = &_TRACE_NVME_IO_CMD_DSTATE 
};
...
TraceEvent _TRACE_NVME_RW_CB_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "nvme_rw_cb",
    .sstate = TRACE_NVME_RW_CB_ENABLED,
    .dstate = &_TRACE_NVME_RW_CB_DSTATE 
};
...
TraceEvent _TRACE_NVME_IDENTIFY_NS_LIST_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "nvme_identify_ns_list",
    .sstate = TRACE_NVME_IDENTIFY_NS_LIST_ENABLED,
    .dstate = &_TRACE_NVME_IDENTIFY_NS_LIST_DSTATE 
};
TraceEvent _TRACE_NVME_IDENTIFY_NS_DESCRIPTOR_LIST_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "nvme_identify_ns_descriptor_list",
    .sstate = TRACE_NVME_IDENTIFY_NS_DESCRIPTOR_LIST_ENABLED,
    .dstate = &_TRACE_NVME_IDENTIFY_NS_DESCRIPTOR_LIST_DSTATE 
};
TraceEvent _TRACE_NVME_GETFEAT_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "nvme_getfeat",
    .sstate = TRACE_NVME_GETFEAT_ENABLED,
    .dstate = &_TRACE_NVME_GETFEAT_DSTATE 
};
TraceEvent _TRACE_NVME_SETFEAT_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "nvme_setfeat",
    .sstate = TRACE_NVME_SETFEAT_ENABLED,
    .dstate = &_TRACE_NVME_SETFEAT_DSTATE 
};
...
TraceEvent _TRACE_NVME_GET_LOG_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "nvme_get_log",
    .sstate = TRACE_NVME_GET_LOG_ENABLED,
    .dstate = &_TRACE_NVME_GET_LOG_DSTATE 
};
TraceEvent _TRACE_NVME_PROCESS_AERS_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "nvme_process_aers",
    .sstate = TRACE_NVME_PROCESS_AERS_ENABLED,
    .dstate = &_TRACE_NVME_PROCESS_AERS_DSTATE 
};
TraceEvent _TRACE_NVME_AER_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "nvme_aer",
    .sstate = TRACE_NVME_AER_ENABLED,
    .dstate = &_TRACE_NVME_AER_DSTATE 
};
TraceEvent _TRACE_NVME_AER_AERL_EXCEEDED_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "nvme_aer_aerl_exceeded",
    .sstate = TRACE_NVME_AER_AERL_EXCEEDED_ENABLED,
    .dstate = &_TRACE_NVME_AER_AERL_EXCEEDED_DSTATE 
};
TraceEvent _TRACE_NVME_AER_MASKED_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "nvme_aer_masked",
    .sstate = TRACE_NVME_AER_MASKED_ENABLED,
    .dstate = &_TRACE_NVME_AER_MASKED_DSTATE 
};
TraceEvent _TRACE_NVME_AER_POST_CQE_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "nvme_aer_post_cqe",
    .sstate = TRACE_NVME_AER_POST_CQE_ENABLED,
    .dstate = &_TRACE_NVME_AER_POST_CQE_DSTATE 
};
TraceEvent _TRACE_NVME_ENQUEUE_REQ_COMPLETION_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "nvme_enqueue_req_completion",
    .sstate = TRACE_NVME_ENQUEUE_REQ_COMPLETION_ENABLED,
    .dstate = &_TRACE_NVME_ENQUEUE_REQ_COMPLETION_DSTATE 
};
TraceEvent _TRACE_NVME_ENQUEUE_EVENT_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "nvme_enqueue_event",
    .sstate = TRACE_NVME_ENQUEUE_EVENT_ENABLED,
    .dstate = &_TRACE_NVME_ENQUEUE_EVENT_DSTATE 
};
TraceEvent _TRACE_NVME_NO_OUTSTANDING_AERS_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "nvme_no_outstanding_aers",
    .sstate = TRACE_NVME_NO_OUTSTANDING_AERS_ENABLED,
    .dstate = &_TRACE_NVME_NO_OUTSTANDING_AERS_DSTATE 
};
...
TraceEvent _TRACE_NVME_ERR_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "nvme_err",
    .sstate = TRACE_NVME_ERR_ENABLED,
    .dstate = &_TRACE_NVME_ERR_DSTATE 
};
TraceEvent _TRACE_NVME_ERR_INVALID_SGL_DESCRIPTOR_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "nvme_err_invalid_sgl_descriptor",
    .sstate = TRACE_NVME_ERR_INVALID_SGL_DESCRIPTOR_ENABLED,
    .dstate = &_TRACE_NVME_ERR_INVALID_SGL_DESCRIPTOR_DSTATE 
};
TraceEvent _TRACE_NVME_ERR_INVALID_SGL_EXCESS_LENGTH_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "nvme_err_invalid_sgl_excess_length",
    .sstate = TRACE_NVME_ERR_INVALID_SGL_EXCESS_LENGTH_ENABLED,
    .dstate = &_TRACE_NVME_ERR_INVALID_SGL_EXCESS_LENGTH_DSTATE 
};
...
TraceEvent _TRACE_NVME_ERR_INVALID_LOG_PAGE_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "nvme_err_invalid_log_page",
    .sstate = TRACE_NVME_ERR_INVALID_LOG_PAGE_ENABLED,
    .dstate = &_TRACE_NVME_ERR_INVALID_LOG_PAGE_DSTATE 
};
...
TraceEvent _TRACE_NVME_ERR_INTERNAL_DEV_ERROR_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "nvme_err_internal_dev_error",
    .sstate = TRACE_NVME_ERR_INTERNAL_DEV_ERROR_ENABLED,
    .dstate = &_TRACE_NVME_ERR_INTERNAL_DEV_ERROR_DSTATE 
};
...
TraceEvent *hw_block_trace_events[] = {
    ...
    &_TRACE_NVME_REGISTER_NAMESPACE_EVENT,
    &_TRACE_NVME_IRQ_MSIX_EVENT,
    &_TRACE_NVME_IRQ_PIN_EVENT,
    &_TRACE_NVME_IRQ_MASKED_EVENT,
    &_TRACE_NVME_DMA_READ_EVENT,
    &_TRACE_NVME_MAP_PRP_EVENT,
    &_TRACE_NVME_MAP_SGL_EVENT,
    &_TRACE_NVME_IO_CMD_EVENT,
    &_TRACE_NVME_RW_EVENT,
    &_TRACE_NVME_RW_CB_EVENT,
    ...
    &_TRACE_NVME_IDENTIFY_NS_LIST_EVENT,
    &_TRACE_NVME_IDENTIFY_NS_DESCRIPTOR_LIST_EVENT,
    &_TRACE_NVME_GETFEAT_EVENT,
    &_TRACE_NVME_SETFEAT_EVENT,
    ...
    &_TRACE_NVME_GET_LOG_EVENT,
    &_TRACE_NVME_PROCESS_AERS_EVENT,
    &_TRACE_NVME_AER_EVENT,
    &_TRACE_NVME_AER_AERL_EXCEEDED_EVENT,
    &_TRACE_NVME_AER_MASKED_EVENT,
    &_TRACE_NVME_AER_POST_CQE_EVENT,
    &_TRACE_NVME_ENQUEUE_REQ_COMPLETION_EVENT,
    &_TRACE_NVME_ENQUEUE_EVENT_EVENT,
    &_TRACE_NVME_NO_OUTSTANDING_AERS_EVENT,
    ...
    &_TRACE_NVME_ERR_EVENT,
    &_TRACE_NVME_ERR_INVALID_SGL_DESCRIPTOR_EVENT,
    &_TRACE_NVME_ERR_INVALID_SGL_EXCESS_LENGTH_EVENT,
    ...
    &_TRACE_NVME_ERR_INVALID_LOG_PAGE_EVENT,
    ...
    &_TRACE_NVME_ERR_INTERNAL_DEV_ERROR_EVENT,
