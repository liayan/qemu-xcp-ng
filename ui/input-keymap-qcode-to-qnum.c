 ...
 * To re-generate, run:
 *   keymap-gen code-map --lang=glib2 --varname=qemu_input_map_qcode_to_qnum keymaps.csv qcode qnum
*/
const guint16 qemu_input_map_qcode_to_qnum[Q_KEY_CODE__MAX] = {
  ...
  [Q_KEY_CODE_F13] = 0x5d, /* qcode:Q_KEY_CODE_F13 (f13) -> linux:183 (KEY_F13) -> qnum:93 */
  [Q_KEY_CODE_F14] = 0x5e, /* qcode:Q_KEY_CODE_F14 (f14) -> linux:184 (KEY_F14) -> qnum:94 */
  [Q_KEY_CODE_F15] = 0x5f, /* qcode:Q_KEY_CODE_F15 (f15) -> linux:185 (KEY_F15) -> qnum:95 */
  [Q_KEY_CODE_F16] = 0x55, /* qcode:Q_KEY_CODE_F16 (f16) -> linux:186 (KEY_F16) -> qnum:85 */
  [Q_KEY_CODE_F17] = 0x83, /* qcode:Q_KEY_CODE_F17 (f17) -> linux:187 (KEY_F17) -> qnum:131 */
  [Q_KEY_CODE_F18] = 0xf7, /* qcode:Q_KEY_CODE_F18 (f18) -> linux:188 (KEY_F18) -> qnum:247 */
  [Q_KEY_CODE_F19] = 0x84, /* qcode:Q_KEY_CODE_F19 (f19) -> linux:189 (KEY_F19) -> qnum:132 */
  [Q_KEY_CODE_F2] = 0x3c, /* qcode:Q_KEY_CODE_F2 (f2) -> linux:60 (KEY_F2) -> qnum:60 */
  [Q_KEY_CODE_F20] = 0x5a, /* qcode:Q_KEY_CODE_F20 (f20) -> linux:190 (KEY_F20) -> qnum:90 */
  [Q_KEY_CODE_F21] = 0x74, /* qcode:Q_KEY_CODE_F21 (f21) -> linux:191 (KEY_F21) -> qnum:116 */
  [Q_KEY_CODE_F22] = 0xf9, /* qcode:Q_KEY_CODE_F22 (f22) -> linux:192 (KEY_F22) -> qnum:249 */
  [Q_KEY_CODE_F23] = 0x6d, /* qcode:Q_KEY_CODE_F23 (f23) -> linux:193 (KEY_F23) -> qnum:109 */
  [Q_KEY_CODE_F24] = 0x6f, /* qcode:Q_KEY_CODE_F24 (f24) -> linux:194 (KEY_F24) -> qnum:111 */
  ...
  [Q_KEY_CODE_LANG1] = 0x72, /* qcode:Q_KEY_CODE_LANG1 (lang1) -> linux:122 (KEY_HANGEUL) -> qnum:114 */
  [Q_KEY_CODE_LANG2] = 0x71, /* qcode:Q_KEY_CODE_LANG2 (lang2) -> linux:123 (KEY_HANJA) -> qnum:113 */
