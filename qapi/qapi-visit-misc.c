...
void visit_type_XenPvDriverInfo_members(Visitor *v, XenPvDriverInfo *obj, Error **errp)
{
    Error *err = NULL;

    visit_type_int(v, "product-num", &obj->product_num, &err);
    if (err) {
        goto out;
    }
    visit_type_int(v, "build-num", &obj->build_num, &err);
    if (err) {
        goto out;
    }
...
void visit_type_XenPvDriverInfo(Visitor *v, const char *name, XenPvDriverInfo **obj, Error **errp)
{
    Error *err = NULL;

    visit_start_struct(v, name, (void **)obj, sizeof(XenPvDriverInfo), &err);
    if (err) {
        goto out;
    }
    if (!*obj) {
    ...
    visit_type_XenPvDriverInfo_members(v, *obj, &err);
    if (err) {
        goto out_obj;
    }
    visit_check_struct(v, &err);
...
void visit_type_q_obj_XEN_PLATFORM_PV_DRIVER_INFO_arg_members(Visitor *v, q_obj_XEN_PLATFORM_PV_DRIVER_INFO_arg *obj, Error **errp)
{
    Error *err = NULL;
