...
void qmp_init_marshal(QmpCommandList *cmds)
{
    ...
    qmp_register_command(cmds, "query-xen-platform-pv-driver-info",
                         qmp_marshal_query_xen_platform_pv_driver_info, QCO_NO_OPTIONS);
    ...
    qmp_register_command(cmds, "query-migratable",
                         qmp_marshal_query_migratable, QCO_NO_OPTIONS);
