...
typedef struct XenPvDriverInfo XenPvDriverInfo;
...
typedef struct q_obj_XEN_PLATFORM_PV_DRIVER_INFO_arg q_obj_XEN_PLATFORM_PV_DRIVER_INFO_arg;
...
void qapi_free_XenPvDriverInfo(XenPvDriverInfo *obj);
...
struct q_obj_XEN_PLATFORM_PV_DRIVER_INFO_arg {
    int64_t product_num;
    int64_t build_num;
};
